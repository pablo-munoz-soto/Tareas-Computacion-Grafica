...
if __name__ == "__main__":
    ...
    gpuRedCube = es.toGPUShape(bs.createColorNormalsCube(1,0,0))
    gpuGreenCube = es.toGPUShape(bs.createColorNormalsCube(0,1,0))
    gpuBlueCube = es.toGPUShape(bs.createColorNormalsCube(0,0,1))
